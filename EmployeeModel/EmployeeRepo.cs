...
namespace EmployeeModel
{
    ...
    {
        public static string connectionString = @"Server=(localdb)\MSSQLLocalDB;Database=PpayRoll_Service;Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true";
	...
	BasicPay,Deduction,TaxablePay,Tax,NetPay,City,Country from Payroll_Service";
